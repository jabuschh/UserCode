{
  ...
  for(int n=0; n<v_WilsonCoeff.size(); n++){
    ...
    */
    ...
    // EFT signals
    dir = "/nfs/dust/cms/user/jabuschh/PhD/ttbar/genstudy/CMSSW_9_4_6/src/UserCode/TopAnalysis/output/";
    ...
    // break;
    c1->SaveAs("/nfs/dust/cms/user/jabuschh/PhD/ttbar/genstudy/CMSSW_9_4_6/src/UserCode/TopAnalysis/plots/SMEFT/ratio_normalizedmtt_" + WilsonCoeff + ".pdf");
    // break;
    c1->Close();
  }
}
