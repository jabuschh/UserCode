{
  ...
  for(int n=0; n<v_WilsonCoeff.size()-1; n++){
    ...
    */
    ...
    h_ditopmass_min5p0->GetXaxis()->SetTitleOffset(1.4);
    // h_ditopmass_min5p0->SetAxisRange(0,4000,"X");
    // y axis
    h_ditopmass_min5p0->GetYaxis()->SetTitle("fraction of #sigma");
    h_ditopmass_min5p0->GetYaxis()->SetTitleOffset(2.0);
    // h_ditopmass_min5p0->SetAxisRange(2E-05,5E-01,"Y");
    gPad->SetLogy();
    ...
    // break;
    c1->SaveAs("/nfs/dust/cms/user/jabuschh/PhD/ttbar/genstudy/CMSSW_9_4_6/src/UserCode/TopAnalysis/plots/SMEFT_interferenceOnly/ditopmass_normalized_logscale_" + WilsonCoeff + ".pdf");
    c1->Close();
  }
}
