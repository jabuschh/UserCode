{
  ...
  for(int n=0; n<v_WilsonCoeff.size()-1; n++){
    ...
    */
    ...
    h_ditopmass_min5p0->SetAxisRange(0.0,0.39,"Y");
    // gPad->SetLogy();
    ...
    c1->SaveAs("/nfs/dust/cms/user/jabuschh/PhD/ttbar/genstudy/CMSSW_9_4_6/src/UserCode/TopAnalysis/plots/SMEFT_interferenceOnly/ditopmass_normalized_" + WilsonCoeff + ".pdf");
    c1->Close();
  }
}
