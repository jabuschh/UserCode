{
  ...
  for(int n=0; n<v_WilsonCoeff.size(); n++){
    ...
    */
    ...
    h_ditopmass_min0p25->GetXaxis()->SetTitleOffset(1.5);
    // h_ditopmass_min0p25->SetAxisRange(0,4000,"X");
    // y axis
    h_ditopmass_min0p25->GetYaxis()->SetTitle("#sigma [pb]");
    h_ditopmass_min0p25->GetYaxis()->SetTitleOffset(1.5);
    h_ditopmass_min0p25->SetAxisRange(1E-05,2E+01,"Y");
    gPad->SetLogy();
    ...
    c1->SaveAs("/nfs/dust/cms/user/jabuschh/PhD/ttbar/genstudy/CMSSW_9_4_6/src/UserCode/TopAnalysis/plots/SMEFT_interferenceOnly/ditopmass_logscale_" + WilsonCoeff + ".pdf");
    // break;
    c1->Close();
  }
}
