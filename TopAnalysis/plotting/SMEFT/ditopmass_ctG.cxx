{
  ...
  for(int n=0; n<v_WilsonCoeff.size(); n++){
    ...
    */
    ...
    h_ditopmass_min0p25->SetAxisRange(0,200,"Y");
    // gPad->SetLogy();
    ...
    c1->SaveAs("/nfs/dust/cms/user/jabuschh/PhD/ttbar/genstudy/CMSSW_9_4_6/src/UserCode/TopAnalysis/plots/SMEFT/ditopmass_" + WilsonCoeff + ".pdf");
    c1->Close();
  }
}
