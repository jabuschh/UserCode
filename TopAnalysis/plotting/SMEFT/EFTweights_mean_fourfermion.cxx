{
  ...
  for(int n=0; n<v_WilsonCoeff.size()-1; n++){
    ...
    */
    ...
    rootfile->cd("rwgt_" + WilsonCoeff + "_min5p0"); TH1F* h_EFTweight_min5p0 = (TH1F*) gDirectory->Get("EFTweight_pure");
    rootfile->cd("rwgt_" + WilsonCoeff + "_min4p0"); TH1F* h_EFTweight_min4p0 = (TH1F*) gDirectory->Get("EFTweight_pure");
    rootfile->cd("rwgt_" + WilsonCoeff + "_min3p0"); TH1F* h_EFTweight_min3p0 = (TH1F*) gDirectory->Get("EFTweight_pure");
    rootfile->cd("rwgt_" + WilsonCoeff + "_min2p0"); TH1F* h_EFTweight_min2p0 = (TH1F*) gDirectory->Get("EFTweight_pure");
    rootfile->cd("rwgt_" + WilsonCoeff + "_min1p0"); TH1F* h_EFTweight_min1p0 = (TH1F*) gDirectory->Get("EFTweight_pure");
    rootfile->cd("rwgt_SM");                         TH1F* h_EFTweight_0p0    = (TH1F*) gDirectory->Get("EFTweight_pure");
    rootfile->cd("rwgt_" + WilsonCoeff + "_1p0");    TH1F* h_EFTweight_1p0    = (TH1F*) gDirectory->Get("EFTweight_pure");
    rootfile->cd("rwgt_" + WilsonCoeff + "_2p0");    TH1F* h_EFTweight_2p0    = (TH1F*) gDirectory->Get("EFTweight_pure");
    rootfile->cd("rwgt_" + WilsonCoeff + "_3p0");    TH1F* h_EFTweight_3p0    = (TH1F*) gDirectory->Get("EFTweight_pure");
    rootfile->cd("rwgt_" + WilsonCoeff + "_4p0");    TH1F* h_EFTweight_4p0    = (TH1F*) gDirectory->Get("EFTweight_pure");
    rootfile->cd("rwgt_" + WilsonCoeff + "_5p0");    TH1F* h_EFTweight_5p0    = (TH1F*) gDirectory->Get("EFTweight_pure");
    ...
    c1->SaveAs("/nfs/dust/cms/user/jabuschh/PhD/ttbar/genstudy/CMSSW_9_4_6/src/UserCode/TopAnalysis/plots/SMEFT/EFTweights_mean_" + WilsonCoeff + ".pdf");
    c1->Close();
  }
