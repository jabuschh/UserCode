{
  ...
  TString filename = "ditopmass_normalized";
  ...
  TString dir = "/nfs/dust/cms/user/jabuschh/PhD/ttbar/genstudy/CMSSW_9_4_6/src/UserCode/TopAnalysis/output/ALP_M1000/";

  TFile *file_CaPhimin5_CaG1 = TFile::Open(dir + "ALP_NPleq2_CaPhimin5_CaG1_M1000.root","READ");
  file_CaPhimin5_CaG1->cd("analysis");
  TH1F *h_CaPhimin5_CaG1 = (TH1F*) gDirectory->Get(histname);

  TFile *file_CaPhi5_CaG1 = TFile::Open(dir + "ALP_NPleq2_CaPhi5_CaG1_M1000.root","READ");
  ...
  legend->Draw("same");
  // save
  c1->SaveAs("/nfs/dust/cms/user/jabuschh/PhD/ttbar/genstudy/CMSSW_9_4_6/src/UserCode/TopAnalysis/plots/ALP_M1000/" + filename + "_NPleq2_CaG1_M1000.pdf");
  c1->Close();
}
