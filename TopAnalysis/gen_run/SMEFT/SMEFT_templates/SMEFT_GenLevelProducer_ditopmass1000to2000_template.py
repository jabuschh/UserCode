...
WilsonCoeff = 'WILSONCOEFFICIENT'

process = cms.Process('myprocess')

process.TFileService=cms.Service("TFileService",fileName=cms.string('/nfs/dust/cms/user/jabuschh/PhD/ttbar/genstudy/CMSSW_9_4_6/src/UserCode/TopAnalysis/gen_output/SMEFT/SMEFT_' + WilsonCoeff + '_ditopmass1000to2000.root'))

process.maxEvents = cms.untracked.PSet(input = cms.untracked.int32(-1))

directory = '/nfs/dust/cms/user/jabuschh/PhD/ttbar/genproduction/CMSSW_7_1_45_patch3/output/SMEFT/'

file_list = []
for nr in range(130):
  file = 'file:' + directory + 'SMEFT_DIM6_ditopmass1000to2000_' + str(nr) + '.root'
