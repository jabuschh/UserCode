...
process.TFileService=cms.Service("TFileService",fileName=cms.string('/nfs/dust/cms/user/jabuschh/PhD/ttbar/genstudy/CMSSW_9_4_6/src/UserCode/TopAnalysis/gen_output/ALP/ALP_' + WilsonCoeff + 'min4_CaG1.root'))
...
file_list = []
for nr in range(10):
  file = 'file:' + directory + 'ALP_CaPhimin4_CaG1_' + str(nr) + '.root'
