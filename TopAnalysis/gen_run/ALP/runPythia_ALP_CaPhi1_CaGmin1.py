...
process.TFileService=cms.Service("TFileService",fileName=cms.string('/nfs/dust/cms/user/jabuschh/PhD/ttbar/genstudy/CMSSW_9_4_6/src/UserCode/TopAnalysis/gen_output/ALP/ALP_CaPhi1_' + WilsonCoeff + 'min1.root'))
...
file_list = []
for nr in range(10):
  file = 'file:' + directory + 'ALP_CaPhi1_CaGmin1_' + str(nr) + '.root'
