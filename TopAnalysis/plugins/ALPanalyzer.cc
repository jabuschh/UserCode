...
ALPanalyzer::ALPanalyzer(edm::ParameterSet const& cfg)
{
...
void ALPanalyzer::analyze(edm::Event const& iEvent, edm::EventSetup const& iSetup)
{
  //reading in tree
...
ALPanalyzer::~ALPanalyzer()
{
}

DEFINE_FWK_MODULE(ALPanalyzer);
