...
void SMEFTanalyzer::analyze(edm::Event const& iEvent, edm::EventSetup const& iSetup)
{
  //reading in tree
...
SMEFTanalyzer::~SMEFTanalyzer()
{
}

DEFINE_FWK_MODULE(SMEFTanalyzer);
