...
void Analysis_Template_MC::beginJob()
{
   ...
   */
   ...
   // EFT weights
   EFTweight_cQq81 = fs->make<TH1F>("EFTweight_cQq81","EFTweight_cQq81",100,-20,20); EFTweight_cQq81->Sumw2();
...
void Analysis_Template_MC::analyze(edm::Event const& iEvent, edm::EventSetup const& iSetup)
{
   ...
   */
   ...
   TString output_filename = "/nfs/dust/cms/user/jabuschh/PhD/ttbar/EFT_LO/genstudy/CMSSW_9_4_6/src/UserCode/TopAnalysis/output/rwgt_cQq81_test.root";
   ...
   for(unsigned int l=0; l<v_EFTweightnames.size(); l++){   //loop over EFT weights
      ...
      cout << "EFT weight: " << weightName_local << endl;
      ...
      for(unsigned  i=0; i<NEntries; i++){
         ...
         // float weight_local = EFTWeights_->at(l);
         // cout << "EFT weight name: " << weightName_local << endl;
         // cout << "     EFT weight: " << weight_local << endl;
         //
         // hweight = (1 + weight_local); //TODO: how to turn the WCs into weights
         // cout << "   event weight: " << hweight << endl;
         ...
         */
         ...
         for(unsigned int b=0; b<EFTWeightsNames_->size(); b++){
            if(weightName_local.EqualTo(EFTWeightsNames_->at(b))) EFTweight_cQq81->Fill(EFTWeights_->at(b));
         }
      }
      cout << "----- 100% -----" << endl;
      ...
      v_hists.push_back(EFTweight_cQq81);
