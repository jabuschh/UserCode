...
filename = '/nfs/dust/cms/user/jabuschh/PhD/ttbar/EFT_LO/genstudy/CMSSW_9_4_6/src/UserCode/TopAnalysis/output/rwgt_cQq81.root'
...
parameter_to_scan = "cQq81" #"ctG"

weight_SM = weight_dataframe.applymap(lambda x: x[get_index("rwgt_SM",weight_dataframe_names)])
weight_EFT_min5 = weight_dataframe.applymap(lambda x: x[get_index("rwgt_"+str(parameter_to_scan)+"_min5p0",weight_dataframe_names)])
weight_EFT_min4 = weight_dataframe.applymap(lambda x: x[get_index("rwgt_"+str(parameter_to_scan)+"_min4p0",weight_dataframe_names)])
weight_EFT_min3 = weight_dataframe.applymap(lambda x: x[get_index("rwgt_"+str(parameter_to_scan)+"_min3p0",weight_dataframe_names)])
