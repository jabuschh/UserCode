...
filename         = cms.string('file:/nfs/dust/cms/user/gunnep/DelphesAnalysis/ntuplizer/output/LG_1300_S130_ntuple.root'),
...
MuSelection      = cms.untracked.bool(False),
HadSelection     = cms.untracked.bool(True),
)
